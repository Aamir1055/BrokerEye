  ...
  return (
    <div className="min-h-screen bg-white flex">
        ...
        <div className={`w-full max-w-md transition-all duration-1000 transform ${
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <a href="#" className="text-[#A0AEC0] hover:text-[#5B8DEF] text-sm transition-colors duration-200">
                Reset Password
              </a>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="flex justify-center gap-4 mb-4">
              <a href="#" className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200">
            ...
            {/* Footer Text Links */}
            <div className="text-center text-xs text-[#A0AEC0] space-x-2">
              <a href="#" className="hover:text-[#5B8DEF] transition-colors duration-200">Terms & Conditions</a>
              <span>|</span>
              <a href="#" className="hover:text-[#5B8DEF] transition-colors duration-200">Privacy Notice</a>
              <span>|</span>
              <a href="#" className="hover:text-[#5B8DEF] transition-colors duration-200">FAQs</a>
              <span>|</span>
              <a href="#" className="hover:text-[#5B8DEF] transition-colors duration-200">Contact Us</a>
              <span>|</span>
              <a href="#" className="hover:text-[#5B8DEF] transition-colors duration-200">Follow Us</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#5B8DEF] via-[#4A7DD8] to-[#3D6FC7]">
          {/* Large Circle Wave */}
          <div className="absolute -right-64 -top-64 w-[800px] h-[800px] bg-[#6B9EFF] rounded-full opacity-30"></div>
          <div className="absolute -right-32 -top-32 w-[600px] h-[600px] bg-[#5B8DEF] rounded-full opacity-40"></div>
          
          {/* Bottom Left Wave */}
          <div className="absolute -left-48 -bottom-48 w-[600px] h-[600px] bg-[#4A7DD8] rounded-full opacity-30"></div>
          <div className="absolute -left-24 -bottom-24 w-[400px] h-[400px] bg-[#6B9EFF] rounded-full opacity-40"></div>
          
          {/* Right Side Large Wave */}
          <div className="absolute right-0 top-0 bottom-0 w-1/2">
            <div className="absolute inset-0 bg-gradient-to-l from-[#3D6FC7] to-transparent opacity-50"></div>
          </div>
        </div>
      </div>
    </div>
