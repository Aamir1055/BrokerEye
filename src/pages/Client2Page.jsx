...
const Client2Page = () => {
  ...
  const getCardIcon = (cardLabel) => {
    ...
    const iconMap = {
      'TOTAL CLIENTS': `${baseUrl}Desktop%20cards%20icons/Total%20Clients.svg`,
      'ASSETS': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'BALANCE': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'BLOCKED COMMISSION': `${baseUrl}Desktop%20cards%20icons/Blocked%20commision.svg`,
      'BLOCKED PROFIT': `${baseUrl}Desktop%20cards%20icons/Floating%20Profit.svg`,
      'COMMISSION': `${baseUrl}Desktop%20cards%20icons/AVAILABLE%20Commision.svg`,
      'CREDIT': `${baseUrl}Desktop%20cards%20icons/Total%20Credit.svg`,
      'DAILY BONUS IN': `${baseUrl}Desktop%20cards%20icons/Daily%20BONUS%20IN.svg`,
      'DAILY BONUS OUT': `${baseUrl}Desktop%20cards%20icons/Daily%20BONUS%20OUT.svg`,
      'DAILY CREDIT IN': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20CREDIT%20IN.svg`,
      'DAILY CREDIT OUT': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20CREDIT%20OUT.svg`,
      'DAILY DEPOSIT': `${baseUrl}Desktop%20cards%20icons/Daily%20Deposite.svg`,
      'DAILY P&L': `${baseUrl}Desktop%20cards%20icons/Daily%20PNL.svg`,
      'DAILY SO COMPENSATION IN': `${baseUrl}Desktop%20cards%20icons/Daily%20BONUS%20IN.svg`,
      'DAILY SO COMPENSATION OUT': `${baseUrl}Desktop%20cards%20icons/Daily%20BONUS%20OUT.svg`,
      'DAILY WITHDRAWAL': `${baseUrl}Desktop%20cards%20icons/Daily%20WITHDRAWL.svg`,
      'DAILY NET D/W': `${baseUrl}Desktop%20cards%20icons/NET%20WD.svg`,
      'NET DAILY BONUS': `${baseUrl}Desktop%20cards%20icons/Net%20Daily%20Bonus.svg`,
      'EQUITY': `${baseUrl}Desktop%20cards%20icons/Total%20Equity.svg`,
      'FLOATING P/L': `${baseUrl}Desktop%20cards%20icons/Floating%20Profit.svg`,
      'FLOATING': `${baseUrl}Desktop%20cards%20icons/Floating%20Profit.svg`,
      'LIABILITIES': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'LIFETIME BONUS IN': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20BONUS%20IN.svg`,
      'LIFETIME BONUS OUT': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20BONUS%20OUT.svg`,
      'LIFETIME CREDIT IN': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20CREDIT%20IN.svg`,
      'LIFETIME CREDIT OUT': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20CREDIT%20OUT.svg`,
      'LIFETIME DEPOSIT': `${baseUrl}Desktop%20cards%20icons/Daily%20Deposite.svg`,
      'LIFETIME P&L': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20PNL.svg`,
      'LIFETIME PNL': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20PNL.svg`,
      'LIFETIME SO COMPENSATION IN': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20BONUS%20IN.svg`,
      'LIFETIME SO COMPENSATION OUT': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20BONUS%20OUT.svg`,
      'LIFETIME WITHDRAWAL': `${baseUrl}Desktop%20cards%20icons/Daily%20WITHDRAWL.svg`,
      'NET LIFETIME DW': `${baseUrl}Desktop%20cards%20icons/NET%20WD.svg`,
      'MARGIN': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'MARGIN FREE': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'THIS MONTH BONUS IN': `${baseUrl}Desktop%20cards%20icons/MONTHLY%20BONUS%20IN.svg`,
      'THIS MONTH BONUS OUT': `${baseUrl}Desktop%20cards%20icons/MONTHLY%20BONUS%20OUt.svg`,
      'THIS MONTH CREDIT IN': `${baseUrl}Desktop%20cards%20icons/MONTHLY CREDIT IN.svg`,
      'THIS MONTH CREDIT OUT': `${baseUrl}Desktop%20cards%20icons/MOnthly CREDIT OUT.svg`,
      'THIS MONTH DEPOSIT': `${baseUrl}Desktop%20cards%20icons/MONTLY DEPOSITE.svg`,
      'THIS MONTH P&L': `${baseUrl}Desktop%20cards%20icons/THIS%20MONTH%20PNL.svg`,
      'THIS MONTH PNL': `${baseUrl}Desktop%20cards%20icons/THIS%20MONTH%20PNL.svg`,
      'THIS MONTH SO COMPENSATION IN': `${baseUrl}Desktop%20cards%20icons/MONTHLY%20BONUS%20IN.svg`,
      'THIS MONTH SO COMPENSATION OUT': `${baseUrl}Desktop%20cards%20icons/MONTHLY%20BONUS%20OUt.svg`,
      'THIS MONTH WITHDRAWAL': `${baseUrl}Desktop%20cards%20icons/MONTLY WITHDRAWL.svg`,
      'NET MONTHLY BONUS': `${baseUrl}Desktop%20cards%20icons/NET%20MONTHLY%20BONUS.svg`,
      'NET MONTHLY DW': `${baseUrl}Desktop%20cards%20icons/NET MONTHLY DW.svg`,
      'PROFIT': `${baseUrl}Desktop%20cards%20icons/Floating%20Profit.svg`,
      'STORAGE': `${baseUrl}Desktop%20cards%20icons/Total%20Balance.svg`,
      'THIS WEEK BONUS IN': `${baseUrl}Desktop%20cards%20icons/Weekly%20bonus%20in.svg`,
      'THIS WEEK BONUS OUT': `${baseUrl}Desktop%20cards%20icons/WEEK%20BONUS%20OUT.svg`,
      'THIS WEEK CREDIT IN': `${baseUrl}Desktop%20cards%20icons/WEEKLY Credit IN.svg`,
      'THIS WEEK CREDIT OUT': `${baseUrl}Desktop%20cards%20icons/WEEKLY CREDIT OUT.svg`,
      'THIS WEEK DEPOSIT': `${baseUrl}Desktop%20cards%20icons/WEEK%20DEPOSITE.svg`,
      'THIS WEEK P&L': `${baseUrl}Desktop%20cards%20icons/This%20week%20pnl.svg`,
      'THIS WEEK PNL': `${baseUrl}Desktop%20cards%20icons/This%20week%20pnl.svg`,
      'THIS WEEK SO COMPENSATION IN': `${baseUrl}Desktop%20cards%20icons/Weekly%20bonus%20in.svg`,
      'THIS WEEK SO COMPENSATION OUT': `${baseUrl}Desktop%20cards%20icons/WEEK%20BONUS%20OUT.svg`,
      'THIS WEEK WITHDRAWAL': `${baseUrl}Desktop%20cards%20icons/WEEK WITHDRAWL.svg`,
      'NET WEEK BONUS': `${baseUrl}Desktop%20cards%20icons/NET%20WEEK%20BONUS.svg`,
      'NET WEEK DW': `${baseUrl}Desktop%20cards%20icons/NET WEEK DAY.svg`,
      'NET LIFETIME BONUS': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20BONUS%20IN.svg`,
      'NET CREDIT': `${baseUrl}Desktop%20cards%20icons/Total%20Credit.svg`,
      'BOOK PNL': `${baseUrl}Desktop%20cards%20icons/PNL.svg`,
      'BOOK P&L': `${baseUrl}Desktop%20cards%20icons/PNL.svg`,
      'AVAILABLE REBATE': `${baseUrl}Desktop%20cards%20icons/AVAILABLE%20Commision.svg`,
      'TOTAL REBATE': `${baseUrl}Desktop%20cards%20icons/TOTAL%20COMMISION.svg`,
      'NET LIFETIME PNL': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20PNL.svg`,
      'P&L': `${baseUrl}Desktop%20cards%20icons/Daily%20PNL.svg`,
      'PNL': `${baseUrl}Desktop%20cards%20icons/Daily%20PNL.svg`,
      // Percentage variants
      'AVAILABLE REBATE %': `${baseUrl}Desktop%20cards%20icons/AVAILABLE%20Commision%25.svg`,
      'TOTAL REBATE %': `${baseUrl}Desktop%20cards%20icons/TOTAL%20COMMISION%25.svg`,
      'NET LIFETIME PNL %': `${baseUrl}Desktop%20cards%20icons/LIFETIME%20PNL.svg`,
      'BOOK PNL %': `${baseUrl}Desktop%20cards%20icons/PNL.svg`,
      'BOOK P&L %': `${baseUrl}Desktop%20cards%20icons/PNL.svg`,
      'DAILY DEPOSIT %': `${baseUrl}Desktop%20cards%20icons/Daily%20Deposite.svg`,
    ...
    return iconMap[normalizedLabel] || `${baseUrl}Desktop%20cards%20icons/Total%20Clients.svg`
  }
      ...
      <main className={`flex-1 p-6 overflow-x-hidden relative z-10 transition-all duration-300 ${sidebarOpen ? 'lg:ml-60' : 'lg:ml-16'}`}>
        <div className="max-w-full mx-auto h-full flex flex-col min-h-0">
          ...
          {showFaceCards && ((totals && Object.keys(totals).length > 0) || (totalsPercent && Object.keys(totalsPercent).length > 0)) && (
            <div className="" ref={faceCardsRef}>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 w-full select-none overflow-x-hidden pb-2" style={{ touchAction: 'pan-y', userSelect: 'none', WebkitUserSelect: 'none' }}>
              {faceCardOrder.map((cardKey) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 mb-1.5 select-none min-h-[20px]">
                        <span className="text-[10px] font-semibold text-[#6B7280] uppercase tracking-wider select-none leading-tight flex-1 break-words overflow-wrap-anywhere">
                          {displayLabel}
                        </span>
                        <div className="w-4 h-4 md:w-5 md:h-5 rounded-md flex items-center justify-center flex-shrink-0 select-none ml-1">
                          <img 
