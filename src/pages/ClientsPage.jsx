                            ...
                            {isFilterable && (
                              <div className="relative" ref={el => {
                                ...
                                {showFilterDropdown === col.baseKey && (
                                  <div className="fixed bg-white border border-gray-300 rounded-lg shadow-2xl z-[9999] w-56" 
                                    style={{
                                      top: `${filterRefs.current[col.baseKey]?.getBoundingClientRect().bottom - 10}px`,
                                      left: `${filterRefs.current[col.baseKey]?.getBoundingClientRect().left}px`
                                    }}>
                                    {/* Header */}
                                    <div className="px-2 py-1 border-b border-gray-200 bg-gray-50 rounded-t-lg">
                                    ...
                                    <div className="border-b border-gray-200">
                                      <button
                                        ...
                                        className="w-full px-2 py-1 text-left text-[11px] hover:bg-gray-50 flex items-center gap-1.5"
                                      >
                                      ...
                                      <button
                                        ...
                                        className="w-full px-2 py-1 text-left text-[11px] hover:bg-gray-50 flex items-center gap-1.5 border-t border-gray-100"
                                      >
                                        <svg className="w-3 h-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      ...
                                      <button
                                        ...
                                        className="w-full px-2 py-1 text-left text-[11px] hover:bg-gray-50 flex items-center gap-1.5 border-t border-gray-100 text-gray-600"
                                      >
                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                                        </svg>
                                    ...
                                    <div className="border-b border-gray-200">
                                      <div className="px-2 py-1 relative group">
                                        <button
                                          ...
                                          className="w-full flex items-center justify-between px-2 py-1 text-[11px] text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50"
                                        >
                                        ...
                                        {showNumberFilterDropdown === col.baseKey && (
                                          <div 
                                            className="absolute left-full top-0 ml-1 w-48 bg-white border border-gray-300 rounded shadow-lg z-50"
                                            onClick={(e) => e.stopPropagation()}
                                          >
                                            <div className="text-[11px] text-gray-600 py-0.5">
                                              <div 
                                    ...
                                    <div className="p-1.5 border-b border-gray-200">
                                      <div className="relative">
                                        <input
                                          ...
                                          onClick={(e) => e.stopPropagation()}
                                          className="w-full px-2 py-1 text-[11px] border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                        />
                                        <svg className="absolute right-1.5 top-1.5 w-3 h-3 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                        </svg>
                                      </div>
                                    </div>
                                      ...
                                      <div className="p-1 space-y-0.5">
                                        {getUniqueColumnValues(col.baseKey).length === 0 ? (
                                          ...
                                          getUniqueColumnValues(col.baseKey).map(value => (
                                            <label 
                                              key={value} 
                                              className="flex items-center gap-1.5 hover:bg-blue-50 px-1.5 py-0.5 rounded cursor-pointer transition-colors"
                                              onClick={(e) => e.stopPropagation()}
                                            >
                                              <input
                                                type="checkbox"
                                    ...
                                    <div className="px-2 py-1 border-t border-gray-200 bg-gray-50 rounded-b-lg flex items-center justify-between">
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation()
                                          clearColumnFilter(col.baseKey)
                                        }}
                                        className="px-2 py-0.5 text-[10px] font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-200 rounded transition-colors"
                                      >
                                        Clear
                                      </button>
                                      <button
