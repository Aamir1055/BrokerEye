                              ...
                              <div className="relative" ref={el => {
                                ...
                                {showFilterDropdown === col.baseKey && (
                                  <div className="fixed bg-white border border-gray-300 rounded shadow-2xl z-[9999] w-40" 
                                    ...
                                    <div className="px-1.5 py-0.5 border-t border-gray-200 bg-gray-50 rounded-b flex items-center justify-between">
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation()
                                          clearColumnFilter(col.baseKey)
                                        }}
                                        className="px-1.5 py-0.5 text-[9px] font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-200 rounded transition-colors"
                                      >
                                        Clear
                                      </button>
                                      <button
                                        ...
                                        className="px-1.5 py-0.5 text-[9px] font-medium text-white bg-blue-600 hover:bg-blue-700 rounded transition-colors"
                                      >
                                        OK
                                      </button>
                                    </div>
