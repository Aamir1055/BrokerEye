                              ...
                              <div className="relative" ref={el => {
                                ...
                                {showFilterDropdown === col.baseKey && (
                                  <div className="fixed bg-white border border-gray-300 rounded-lg shadow-2xl z-[9999] w-64" 
                                    style={{
                                      top: `${filterRefs.current[col.baseKey]?.getBoundingClientRect().bottom + 5}px`,
                                      ...
                                      <div className="p-2 space-y-1">
                                        {getUniqueColumnValues(col.baseKey).length === 0 ? (
                                          ...
                                          getUniqueColumnValues(col.baseKey).map(value => (
                                            <label 
                                              key={value} 
                                              className="flex items-center gap-2 hover:bg-blue-50 px-2 py-1.5 rounded cursor-pointer transition-colors"
                                              onClick={(e) => e.stopPropagation()}
                                            >
                                              <input
                                                type="checkbox"
                                    ...
                                    <div className="px-3 py-2 border-t border-gray-200 bg-gray-50 rounded-b-lg flex items-center justify-between">
                                      <button
                                        ...
                                        className="px-3 py-1.5 text-xs font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-200 rounded transition-colors"
                                      >
                                        Clear
                                      </button>
                                      <button
