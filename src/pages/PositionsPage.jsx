                      ...
                      <thead className="bg-blue-600 sticky top-0 shadow-md" style={{ zIndex: 10 }}>
                        <tr>
                          {netVisibleColumns.symbol && (
                            <th 
                              className="px-2 py-2 text-left text-[11px] font-bold text-white uppercase tracking-wider cursor-pointer hover:bg-blue-700/70 hover:text-white transition-all select-none group"
