  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black/50 z-[999] flex items-end lg:hidden">
        ...
        {/* Table Content - Scrollable Area (no vertical or horizontal scroll in Balance tab) */}
        <div className={`flex-1 min-h-0 ${activeTab === 'funds' ? 'overflow-y-hidden overflow-x-hidden' : 'overflow-y-auto overflow-x-auto'} bg-gray-50`}>
          {loading ? (
