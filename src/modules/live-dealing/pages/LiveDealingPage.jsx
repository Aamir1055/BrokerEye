...
import { WebSocketIndicator, LoadingSpinner } from '../../../shared/components/feedback'
  ...
  const getInitialVisibleColumns = () => {
    ...
    if (saved) {
      try {
        ...
        // Enforce module defaults: any default-true column must remain visible
        Object.keys(defaults).forEach(k => { if (defaults[k]) merged[k] = true })
        return merged
      } catch (e) {
          ...
          <div className="bg-white rounded-2xl shadow-sm px-6 py-3 mb-6">
            ...
            <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="h-8 w-8 rounded-md bg-white border border-[#E5E7EB] text-[#374151] shadow-sm inline-flex items-center justify-center hover:bg-gray-50 hover:text-[#1F2937] transition-colors"
                    title="Refresh"
                    aria-label="Refresh"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
