  ...
  return (
    <>
      ...
      >
        ...
        {/* Sidebar Content */}
        <div className="flex-1 p-4 pt-6 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
          {/* Navigation Label */}
          ...
          <nav className="space-y-2">
            {navigationItems.map((item) => (
              <button
                ...
                className={`
                  group w-full text-left flex items-center px-4 py-3 rounded-xl text-sm font-medium
              ...
              >
                {item.icon === 'dashboard' && (
                  <svg className={`w-5 h-5 mr-3 transition-transform duration-200 ${isActivePath(item.path) ? '' : 'group-hover:scale-110'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {item.icon === 'settings' && (
                  <svg className={`w-5 h-5 mr-3 transition-transform duration-200 ${isActivePath(item.path) ? '' : 'group-hover:scale-110 group-hover:rotate-90'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
