...
export default function DashboardMobileView({ 
  ...
  const getCardIcon = (cardTitle) => {
    const iconMap = {
      ...
      'Net DW': '/Desktop cards icons/NET WD.svg',
      'Total Commission': '/Desktop cards icons/TOTAL COMMISION.svg',
      'Available Commission': '/Desktop cards icons/AVAILABLE Commision.svg',
      'Total Commission %': '/Desktop cards icons/TOTAL COMMISION%25.svg',
      'Available Commission %': '/Desktop cards icons/AVAILABLE Commision%25.svg',
