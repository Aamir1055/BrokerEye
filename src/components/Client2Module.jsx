...
export default function Client2Module() {
  ...
  const getCardIcon = (cardLabel) => {
    ...
    const iconMap = {
      ...
      'Month Bonus In': '/Desktop cards icons/MONTHLY BONUS IN.svg',
      'Month Bonus Out': '/Desktop cards icons/MONTHLY BONUS OUt.svg',
      'Month Credit In': '/Desktop cards icons/MONTHLY CREDIT IN.svg',
      'Month Credit Out': '/Desktop cards icons/MOnthly CREDIT OUT.svg',
      'Month Deposit': '/Desktop cards icons/MONTLY DEPOSITE.svg',
      'Month P&L': '/Desktop cards icons/THIS MONTH PNL.svg',
      'Month SO Compensation In': '/Desktop cards icons/MONTHLY BONUS IN.svg',
      'Month SO Compensation Out': '/Desktop cards icons/MONTHLY BONUS OUt.svg',
      'Month Withdrawal': '/Desktop cards icons/MONTLY WITHDRAWL.svg',
      'NET Month Bonus': '/Desktop cards icons/NET MONTHLY BONUS.svg',
      'NET Month D/W': '/Desktop cards icons/NET MONTHLY DW.svg',
      ...
      'Week Credit In': '/Desktop cards icons/WEEKLY Credit IN.svg',
      'Week Credit Out': '/Desktop cards icons/WEEKLY CREDIT OUT.svg',
      'Week Deposit': '/Desktop cards icons/WEEK DEPOSITE.svg',
      'Week P&L': '/Desktop cards icons/This week pnl.svg',
      'Week SO Compensation In': '/Desktop cards icons/Weekly bonus in.svg',
      'Week SO Compensation Out': '/Desktop cards icons/WEEK BONUS OUT.svg',
      'Week Withdrawal': '/Desktop cards icons/WEEK WITHDRAWL.svg',
      'NET Week Bonus': '/Desktop cards icons/NET WEEK BONUS.svg',
      'NET Week D/W': '/Desktop cards icons/NET WEEK DAY.svg',
      'Book PnL': '/Desktop cards icons/PNL.svg',
    }
    return iconMap[cleanLabel] || '/Desktop cards icons/Total Clients.svg' // Default icon
  }
