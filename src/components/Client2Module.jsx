  ...
  const cards = useMemo(() => {
    ...
    if (isFiltered && Array.isArray(filteredClients) && filteredClients.length > 0) {
      ...
      return [
        ...
        { label: addPercent('Assets'), value: formatNum(t.assets), unit, numericValue: t.assets },
        { label: addPercent('Balance'), value: formatNum(t.balance), unit, numericValue: t.balance },
        { label: addPercent('Credit'), value: formatNum(t.credit), unit, numericValue: t.credit },
        { label: addPercent('Equity'), value: formatNum(t.equity), unit, numericValue: t.equity },
        { label: addPercent('Floating P/L'), value: formatNum(t.floating), unit, numericValue: t.floating },
        { label: addPercent('Profit'), value: formatNum(t.profit), unit, numericValue: t.profit },
        { label: addPercent('Margin'), value: formatNum(t.margin), unit, numericValue: t.margin },
        { label: addPercent('Margin Free'), value: formatNum(t.marginFree), unit, numericValue: t.marginFree },
        { label: addPercent('Daily Deposit'), value: formatNum(t.dailyDeposit), unit, numericValue: t.dailyDeposit },
        { label: addPercent('Daily Withdrawal'), value: formatNum(t.dailyWithdrawal), unit, numericValue: t.dailyWithdrawal },
        { label: addPercent('Daily Net D/W'), value: formatNum(t.dailyDeposit - t.dailyWithdrawal), unit, numericValue: t.dailyDeposit - t.dailyWithdrawal },
        { label: addPercent('Daily P&L'), value: formatNum(t.dailyPnL), unit, numericValue: t.dailyPnL },
        { label: addPercent('Lifetime Deposit'), value: formatNum(t.lifetimeDeposit), unit, numericValue: t.lifetimeDeposit },
        { label: addPercent('Lifetime Withdrawal'), value: formatNum(t.lifetimeWithdrawal), unit, numericValue: t.lifetimeWithdrawal },
        { label: addPercent('NET Lifetime DW'), value: formatNum(t.lifetimeDeposit - t.lifetimeWithdrawal), unit, numericValue: t.lifetimeDeposit - t.lifetimeWithdrawal },
        { label: addPercent('Lifetime P&L'), value: formatNum(t.lifetimePnL), unit, numericValue: t.lifetimePnL },
        { label: addPercent('Book PnL'), value: formatNum(t.lifetimePnL + t.floating), unit, numericValue: t.lifetimePnL + t.floating }
      ]
    }
    ...
    return [
      ...
      { label: addPercent('Assets'), value: formatNum(t.assets || 0), unit, numericValue: t.assets || 0 },
      { label: addPercent('Balance'), value: formatNum(t.balance || 0), unit, numericValue: t.balance || 0 },
      { label: addPercent('Blocked Commission'), value: formatNum(t.blockedCommission || 0), unit, numericValue: t.blockedCommission || 0 },
      { label: addPercent('Blocked Profit'), value: formatNum(t.blockedProfit || 0), unit, numericValue: t.blockedProfit || 0 },
      { label: addPercent('Commission'), value: formatNum(t.commission || 0), unit, numericValue: t.commission || 0 },
      { label: addPercent('Credit'), value: formatNum(t.credit || 0), unit, numericValue: t.credit || 0 },
      { label: addPercent('Daily Bonus In'), value: formatNum(t.dailyBonusIn || 0), unit, numericValue: t.dailyBonusIn || 0 },
      { label: addPercent('Daily Bonus Out'), value: formatNum(t.dailyBonusOut || 0), unit, numericValue: t.dailyBonusOut || 0 },
      { label: addPercent('Daily Credit In'), value: formatNum(t.dailyCreditIn || 0), unit, numericValue: t.dailyCreditIn || 0 },
      { label: addPercent('Daily Credit Out'), value: formatNum(t.dailyCreditOut || 0), unit, numericValue: t.dailyCreditOut || 0 },
      { label: addPercent('Daily Deposit'), value: formatNum(t.dailyDeposit || 0), unit, numericValue: t.dailyDeposit || 0 },
      { label: addPercent('Daily P&L'), value: formatNum(t.dailyPnL || 0), unit, numericValue: t.dailyPnL || 0 },
      { label: addPercent('Daily SO Compensation In'), value: formatNum(t.dailySOCompensationIn || 0), unit, numericValue: t.dailySOCompensationIn || 0 },
      { label: addPercent('Daily SO Compensation Out'), value: formatNum(t.dailySOCompensationOut || 0), unit, numericValue: t.dailySOCompensationOut || 0 },
      { label: addPercent('Daily Withdrawal'), value: formatNum(t.dailyWithdrawal || 0), unit, numericValue: t.dailyWithdrawal || 0 },
      { label: addPercent('Daily Net D/W'), value: formatNum((t.dailyDeposit || 0) - (t.dailyWithdrawal || 0)), unit, numericValue: (t.dailyDeposit || 0) - (t.dailyWithdrawal || 0) },
      { label: addPercent('NET Daily Bonus'), value: formatNum((t.dailyBonusIn || 0) - (t.dailyBonusOut || 0)), unit, numericValue: (t.dailyBonusIn || 0) - (t.dailyBonusOut || 0) },
      { label: addPercent('Equity'), value: formatNum(t.equity || 0), unit, numericValue: t.equity || 0 },
      { label: addPercent('Floating P/L'), value: formatNum(t.floating || 0), unit, numericValue: t.floating || 0 },
      { label: addPercent('Liabilities'), value: formatNum(t.liabilities || 0), unit, numericValue: t.liabilities || 0 },
      { label: addPercent('Lifetime Bonus In'), value: formatNum(t.lifetimeBonusIn || 0), unit, numericValue: t.lifetimeBonusIn || 0 },
      { label: addPercent('Lifetime Bonus Out'), value: formatNum(t.lifetimeBonusOut || 0), unit, numericValue: t.lifetimeBonusOut || 0 },
      { label: addPercent('Lifetime Credit In'), value: formatNum(t.lifetimeCreditIn || 0), unit, numericValue: t.lifetimeCreditIn || 0 },
      { label: addPercent('Lifetime Credit Out'), value: formatNum(t.lifetimeCreditOut || 0), unit, numericValue: t.lifetimeCreditOut || 0 },
      { label: addPercent('Lifetime Deposit'), value: formatNum(t.lifetimeDeposit || 0), unit, numericValue: t.lifetimeDeposit || 0 },
      { label: addPercent('Lifetime P&L'), value: formatNum(t.lifetimePnL || 0), unit, numericValue: t.lifetimePnL || 0 },
      { label: addPercent('Lifetime SO Compensation In'), value: formatNum(t.lifetimeSOCompensationIn || 0), unit, numericValue: t.lifetimeSOCompensationIn || 0 },
      { label: addPercent('Lifetime SO Compensation Out'), value: formatNum(t.lifetimeSOCompensationOut || 0), unit, numericValue: t.lifetimeSOCompensationOut || 0 },
      { label: addPercent('Lifetime Withdrawal'), value: formatNum(t.lifetimeWithdrawal || 0), unit, numericValue: t.lifetimeWithdrawal || 0 },
      { label: addPercent('Margin'), value: formatNum(t.margin || 0), unit, numericValue: t.margin || 0 },
      { label: addPercent('Margin Free'), value: formatNum(t.marginFree || 0), unit, numericValue: t.marginFree || 0 },
      { label: addPercent('Margin Initial'), value: formatNum(t.marginInitial || 0), unit, numericValue: t.marginInitial || 0 },
      { label: 'Margin Level', value: formatNum(t.marginLevel || 0), unit: '%', numericValue: t.marginLevel || 0 },
      { label: addPercent('Margin Maintenance'), value: formatNum(t.marginMaintenance || 0), unit, numericValue: t.marginMaintenance || 0 },
      { label: addPercent('P&L'), value: formatNum(t.pnl || 0), unit, numericValue: t.pnl || 0 },
      { label: addPercent('Previous Equity'), value: formatNum(t.previousEquity || 0), unit, numericValue: t.previousEquity || 0 },
      { label: addPercent('Profit'), value: formatNum(t.profit || 0), unit, numericValue: t.profit || 0 },
      { label: addPercent('SO Equity'), value: formatNum(t.soEquity || 0), unit, numericValue: t.soEquity || 0 },
      { label: 'SO Level', value: formatNum(t.soLevel || 0), unit: '%', numericValue: t.soLevel || 0 },
      { label: addPercent('SO Margin'), value: formatNum(t.soMargin || 0), unit, numericValue: t.soMargin || 0 },
      { label: addPercent('Storage'), value: formatNum(t.storage || 0), unit, numericValue: t.storage || 0 },
      { label: addPercent('This Month Bonus In'), value: formatNum(t.thisMonthBonusIn || 0), unit, numericValue: t.thisMonthBonusIn || 0 },
      { label: addPercent('This Month Bonus Out'), value: formatNum(t.thisMonthBonusOut || 0), unit, numericValue: t.thisMonthBonusOut || 0 },
      { label: addPercent('This Month Credit In'), value: formatNum(t.thisMonthCreditIn || 0), unit, numericValue: t.thisMonthCreditIn || 0 },
      { label: addPercent('This Month Credit Out'), value: formatNum(t.thisMonthCreditOut || 0), unit, numericValue: t.thisMonthCreditOut || 0 },
      { label: addPercent('This Month Deposit'), value: formatNum(t.thisMonthDeposit || 0), unit, numericValue: t.thisMonthDeposit || 0 },
      { label: addPercent('This Month P&L'), value: formatNum(t.thisMonthPnL || 0), unit, numericValue: t.thisMonthPnL || 0 },
      { label: addPercent('This Month SO Compensation In'), value: formatNum(t.thisMonthSOCompensationIn || 0), unit, numericValue: t.thisMonthSOCompensationIn || 0 },
      { label: addPercent('This Month SO Compensation Out'), value: formatNum(t.thisMonthSOCompensationOut || 0), unit, numericValue: t.thisMonthSOCompensationOut || 0 },
      { label: addPercent('This Month Withdrawal'), value: formatNum(t.thisMonthWithdrawal || 0), unit, numericValue: t.thisMonthWithdrawal || 0 },
      { label: addPercent('This Week Bonus In'), value: formatNum(t.thisWeekBonusIn || 0), unit, numericValue: t.thisWeekBonusIn || 0 },
      { label: addPercent('This Week Bonus Out'), value: formatNum(t.thisWeekBonusOut || 0), unit, numericValue: t.thisWeekBonusOut || 0 },
      { label: addPercent('This Week Credit In'), value: formatNum(t.thisWeekCreditIn || 0), unit, numericValue: t.thisWeekCreditIn || 0 },
      { label: addPercent('This Week Credit Out'), value: formatNum(t.thisWeekCreditOut || 0), unit, numericValue: t.thisWeekCreditOut || 0 },
      { label: addPercent('This Week Deposit'), value: formatNum(t.thisWeekDeposit || 0), unit, numericValue: t.thisWeekDeposit || 0 },
      { label: addPercent('This Week P&L'), value: formatNum(t.thisWeekPnL || 0), unit, numericValue: t.thisWeekPnL || 0 },
      { label: addPercent('This Week SO Compensation In'), value: formatNum(t.thisWeekSOCompensationIn || 0), unit, numericValue: t.thisWeekSOCompensationIn || 0 },
      { label: addPercent('This Week SO Compensation Out'), value: formatNum(t.thisWeekSOCompensationOut || 0), unit, numericValue: t.thisWeekSOCompensationOut || 0 },
      { label: addPercent('This Week Withdrawal'), value: formatNum(t.thisWeekWithdrawal || 0), unit, numericValue: t.thisWeekWithdrawal || 0 },
      { label: addPercent('NET Week Bonus'), value: formatNum((t.thisWeekBonusIn || 0) - (t.thisWeekBonusOut || 0)), unit, numericValue: (t.thisWeekBonusIn || 0) - (t.thisWeekBonusOut || 0) },
      { label: addPercent('NET Week DW'), value: formatNum((t.thisWeekDeposit || 0) - (t.thisWeekWithdrawal || 0)), unit, numericValue: (t.thisWeekDeposit || 0) - (t.thisWeekWithdrawal || 0) },
      { label: addPercent('NET Monthly Bonus'), value: formatNum((t.thisMonthBonusIn || 0) - (t.thisMonthBonusOut || 0)), unit, numericValue: (t.thisMonthBonusIn || 0) - (t.thisMonthBonusOut || 0) },
      { label: addPercent('NET Monthly DW'), value: formatNum((t.thisMonthDeposit || 0) - (t.thisMonthWithdrawal || 0)), unit, numericValue: (t.thisMonthDeposit || 0) - (t.thisMonthWithdrawal || 0) },
      { label: addPercent('NET Lifetime Bonus'), value: formatNum((t.lifetimeBonusIn || 0) - (t.lifetimeBonusOut || 0)), unit, numericValue: (t.lifetimeBonusIn || 0) - (t.lifetimeBonusOut || 0) },
      { label: addPercent('NET Lifetime DW'), value: formatNum((t.lifetimeDeposit || 0) - (t.lifetimeWithdrawal || 0)), unit, numericValue: (t.lifetimeDeposit || 0) - (t.lifetimeWithdrawal || 0) },
      { label: addPercent('NET Credit'), value: formatNum((t.lifetimeCreditIn || 0) - (t.lifetimeCreditOut || 0)), unit, numericValue: (t.lifetimeCreditIn || 0) - (t.lifetimeCreditOut || 0) },
      { label: addPercent('Book PnL'), value: formatNum((t.lifetimePnL || 0) + (t.floating || 0)), unit, numericValue: (t.lifetimePnL || 0) + (t.floating || 0) }
    ]
