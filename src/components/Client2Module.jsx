...
export default function Client2Module() {
  ...
  const [visibleColumns, setVisibleColumns] = useState({
    ...
    blockedCommission: false,
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '14px' }}>
                  <span style={{ color: '#4B4B4B', fontSize: '10px', fontWeight: 600, lineHeight: '14px', paddingRight: '4px', whiteSpace: 'nowrap' }}>{card.label}</span>
    ...
    leadSource: false,
    soActivation: false,
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '4px', height: '18px' }}>
    soLevel: false,
                    fontSize: '14px',
    soTime: false,
                    lineHeight: '18px',
