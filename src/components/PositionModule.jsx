          ...
          <div className="bg-[#F5F7FA] flex flex-col h-full">
            ...
            <div className="flex items-center gap-2 pb-3 px-4">
                ...
                <button
                  ...
                  className={`w-5.5 h-5.5 rounded-lg flex items-center justify-center flex-shrink-0 ${clientNetCurrentPage === 1 ? 'text-gray-300 bg-gray-100' : 'text-gray-700 bg-white border border-gray-300'}`}
                >
                ...
                <button
                  ...
                  className={`w-5.5 h-5.5 rounded-lg flex items-center justify-center flex-shrink-0 ${clientNetCurrentPage === clientNetTotalPages ? 'text-gray-300 bg-gray-100' : 'text-gray-700 bg-white border border-gray-300'}`}
                >
                  <svg width="10" height="10" viewBox="0 0 16 16" fill="none">
                    <path d="M6 4L10 8L6 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
