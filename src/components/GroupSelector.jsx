  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="px-2.5 py-1.5 rounded-xl bg-white border border-[#E5E7EB] hover:bg-gray-50 transition-colors inline-flex items-center gap-1.5 text-xs font-medium text-[#374151] shadow-sm h-8"
      >
