  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="text-slate-700 hover:text-slate-900 px-3 py-2 rounded-xl hover:bg-slate-50 border-2 border-slate-300 hover:border-slate-500 transition-all inline-flex items-center gap-2 text-sm font-semibold bg-white shadow-sm h-9"
      >
