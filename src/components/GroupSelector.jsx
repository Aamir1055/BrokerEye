  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="text-green-700 hover:text-green-900 px-4 py-2.5 rounded-xl hover:bg-green-50 border-2 border-green-400 hover:border-green-600 transition-all inline-flex items-center gap-2 text-sm font-semibold bg-white shadow-sm h-10"
      >
